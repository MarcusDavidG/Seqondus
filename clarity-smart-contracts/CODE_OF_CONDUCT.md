...
- **Email**: [Contact the project maintainer directly through GitHub]
- **Direct Message**: Contact maintainers through GitHub
...
* **Be inclusive**: Ensure all voices are heard and valued

## Specific Guidelines for Technical Discussions
...
* Be respectful when disagreeing with decisions
...
* Welcome improvements from all contributors
...
2. Check if your question is addressed in the FAQ
